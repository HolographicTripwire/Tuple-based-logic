...
// impl <'a, E: Clone> ErrorInProof<'a, E> {
//     /// Create a new error, which is located at the current step of the proof
//     pub fn here(err: &'a E) -> Self { Self(ObjAtPath::from_at(err, ProofInProofPath::empty())) }
...
// pub enum ResultInProof<'a, T,E: Clone> {
//     Ok(T), Err(E),
//     ErrNest(ErrorInProof<'a, E>)
// }
