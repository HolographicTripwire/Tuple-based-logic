...
pub enum UnwrapInvocationPropositionError {
    PropositionAtomic(OwnedPropositionInInference),
    NoFirstElement(OwnedPropositionInInference),
...
pub fn unwrap_invocation_proposition<'a>(invocation: &'a PropositionInInference<'a>, expected_head: &Expression) -> Result<Vec<ExpressionInInference<'a>>,UnwrapInvocationPropositionError>{
...
pub fn unwrap_fixed_length_invocation_proposition<'a,const N: usize>(invocation: &'a PropositionInInference<'a>, expected_head: &Expression) -> Result<Box<[ExpressionInInference<'a>; N]>,Either<UnwrapInvocationPropositionError,PropositionLengthCheckError>>{
    let vec = proposition_as_slice(invocation)
