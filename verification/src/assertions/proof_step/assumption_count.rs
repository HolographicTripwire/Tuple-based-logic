...
fn assumption_count_check<'a,Rule:InferenceRule>(expected_count: usize) -> StringifiablePredicate<1,OwnedSubproofInProof<Rule>> { StringifiablePredicate::new(
...
pub fn assert_assumption_count<'a,Rule:InferenceRule>(step: OwnedSubproofInProof<Rule>, expected_count: usize) -> Result<(), ProofStepSpecificationError> {
