...
fn assumption_count_predicate<'a,Rule:InferenceRule>(expected_count: usize) -> impl NaryPredicate<'a,1,OwnedSubproofInProof<Rule>> {
...
fn assumption_count_stringifier<'a,Rule:InferenceRule>(expected_count: usize) -> impl NaryStringifier<'a,1,OwnedSubproofInProof<Rule>> {
...
pub fn assumption_count_check<'a,Rule:InferenceRule>(expected_count: usize) -> StringifiablePredicate<'a,1,OwnedSubproofInProof<Rule>> { StringifiablePredicate::new(
...
pub fn assert_assumption_count<'a,Rule:InferenceRule>(step: OwnedSubproofInProof<Rule>, expected_count: usize) -> Result<(), ProofStepSpecificationError<'a>> {
