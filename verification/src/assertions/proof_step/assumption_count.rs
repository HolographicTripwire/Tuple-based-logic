...
fn assumption_count_predicate<'a,Rule:InferenceRule>(expected_count: usize) -> impl NaryPredicate<'a,OwnedInferenceInProof<Rule>> {
...
pub fn assumption_count_stringifier<'a,Rule:InferenceRule>(expected_count: usize) -> impl NaryStringifier<'a,OwnedInferenceInProof<Rule>> {
