...
pub fn expression_atomicity_inequality_predicate<'a>() -> impl NaryPredicate<'a,[OwnedExpressionInProof;2]> {
...
pub fn expression_atomicity_inequality_stringifier<'a>() -> impl NaryStringifier<'a,[OwnedExpressionInProof;2]> {
