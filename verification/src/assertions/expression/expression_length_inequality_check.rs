...
/// Get an [AssessedErrorStringifier] which takes an [Expressions](OwnedExpressionInProof) and returns an error message saying that their lengths aren't inequal
pub fn expression_length_inequality_stringifier<'a, const N: usize>() -> impl AssessedErrorStringifier<'a,[OwnedExpressionInProof;N],()> {
...
pub fn expression_length_inequality_check<'a, const N: usize>() -> ErrorStringifiableAssessor<'a,[OwnedExpressionInProof;N],(),()> { ErrorStringifiableAssessor::new(
