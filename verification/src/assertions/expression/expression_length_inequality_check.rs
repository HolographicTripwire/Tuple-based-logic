...
pub fn expression_length_inequality_predicate<'a,const N: usize>() -> impl NaryPredicate<'a,[OwnedExpressionInProof;N]> {
...
pub fn expression_length_inequality_stringifier<'a, const N: usize>() -> impl NaryStringifier<'a,[OwnedExpressionInProof;N]> {
