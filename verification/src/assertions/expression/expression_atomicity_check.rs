...
pub fn expression_atomicity_predicate<'a>(atomicity_expected: bool) -> impl NaryPredicate<'a,OwnedExpressionInProof> {
...
pub fn expression_atomicity_stringifier<'a>(atomicity_expected: bool) -> impl NaryStringifier<'a,OwnedExpressionInProof> {
    move |o: OwnedExpressionInProof| format!(
