...
pub fn expression_value_predicate<'a>(value_expected: Expression) -> impl Assessor<'a,OwnedExpressionInProof,()> {
...
pub fn expression_value_stringifier<'a>(value_expected: Expression, style: ExpressionStyle<'a>) -> impl AssessedStringifier<'a,OwnedExpressionInProof,()> {
    move |o: OwnedExpressionInProof,_| {
    format!(
