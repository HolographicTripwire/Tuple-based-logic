...
pub fn expression_value_inequality_predicate<'a,const N: usize>() -> impl NaryPredicate<'a,[OwnedExpressionInProof;N]> {
...
pub fn expression_value_inequality_stringifier<'a,const N:usize>(style: ExpressionStyle<'a>) -> impl NaryStringifier<'a,[OwnedExpressionInProof;N]> {
...
pub fn expression_value_inequality_check<'a,const N: usize>(style: ExpressionStyle<'a>) -> StringifiablePredicate<'a,[OwnedExpressionInProof;N]> { StringifiablePredicate::new(
