...
pub fn expression_length_predicate<'a>(expected_length: usize) -> impl NaryPredicate<'a,OwnedExpressionInProof> {
...
pub fn expression_length_stringifier<'a>(length_expected: usize) -> impl NaryStringifier<'a,OwnedExpressionInProof> {
