...
pub fn proposition_atomicity_inequality_stringifier<'a>() -> impl NaryStringifier<'a,2,OwnedPropositionInProof> {
...
pub fn proposition_atomicity_inequality_check<'a>() -> StringifiablePredicate<'a,2,OwnedPropositionInProof> { StringifiablePredicate::new(
