...
fn proposition_value_stringifier<'a>(value_expected: Proposition, style: ExpressionStyle<'a>) -> impl NaryStringifier<'a,1,OwnedPropositionInProof> {
    move |o: [OwnedPropositionInProof; 1]| {
    format!(
...
pub fn proposition_value_check<'a>(value_expected: Proposition, style: ExpressionStyle<'a>) -> StringifiablePredicate<'a,1,OwnedPropositionInProof> { StringifiablePredicate::new(
