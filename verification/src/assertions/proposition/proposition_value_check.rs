...
fn proposition_value_stringifier<'a>(value_expected: Proposition, style: ExpressionStyle<'a>) -> impl AssessedErrorStringifier<'a,OwnedPropositionInProof,()> {
...
pub fn proposition_value_check<'a>(value_expected: Proposition, style: ExpressionStyle<'a>) -> ErrorStringifiableAssessor<'a,OwnedPropositionInProof,()> { ErrorStringifiableAssessor::new(
