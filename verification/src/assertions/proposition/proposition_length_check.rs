...
fn proposition_length_predicate<'a>(expected_length: usize) -> impl NaryPredicate<'a,OwnedPropositionInProof> {
...
pub fn proposition_length_stringifier<'a>(length_expected: usize) -> impl NaryStringifier<'a,OwnedPropositionInProof> {
