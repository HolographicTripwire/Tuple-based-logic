use tbl_structures::{expressions::{Proposition, PropositionSet}, proof::{Proof, error::OwnedErrorInProof}};
...
pub fn verify_proof_soundness<'a, E: Clone, Rule: VerifiableInferenceRule<E>>(proof: &'a Proof<Rule>, assumptions: &PropositionSet) -> Result<(),ProofSoundnessError<E>> {
...
pub fn get_proof_soundness_errors<'a, E: Clone, Rule: VerifiableInferenceRule<E>>(proof: &'a Proof<Rule>, assumptions: &PropositionSet) -> impl Iterator<Item = ProofSoundnessError<E>> {
