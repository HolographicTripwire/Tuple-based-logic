use crate::{proofs::{errors::{ValidatableInferenceRule, stepper::result::ProofValidityStepResultWrapper, validate_located_inference}, inferences::located::InferenceAtPath}, propositions::types::assigned::Proposition};
