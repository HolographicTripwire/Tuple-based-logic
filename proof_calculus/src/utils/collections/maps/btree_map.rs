...
impl<K: Ord + Clone, V1, V2> MapWithTransformableValues<K, V1, V2> for BTreeMap<K, V1> {
    type SelfTransformed = BTreeMap<K, V2>;
...
impl<K: Ord + Clone, V: PartialEq<V>> MapWithoutConflicts<K, V> for BTreeMap<K, V> {
