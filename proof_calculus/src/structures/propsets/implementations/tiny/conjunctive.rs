...
use crate::{structures::{propsets::{Cnf, CnfClause}, propositions::Proposition}, utils::{collections::tiny_immutable_ordered_set::TinyImmutableOrderedSet, traits::fast_ord::FastOrd}};

#[derive(Clone,PartialEq,Eq,Hash,Debug)]
pub struct TinyCnf<P: Proposition + FastOrd>(TinyImmutableOrderedSet<TinyCnfClause<P>>);
...
impl <P: Proposition + FastOrd> Deref for TinyCnf<P> {
    type Target = TinyImmutableOrderedSet<TinyCnfClause<P>>;
...
pub struct TinyCnfClause<P: Proposition + FastOrd>(TinyImmutableOrderedSet<P>);
