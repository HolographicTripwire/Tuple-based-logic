use crate::{structures::{propositions::{Proposition,collections::sets::{PropSet1O, PropSet2O}}}, utils::{collections::tiny_immutable_ordered_set::TinyImmutableOrderedSet, traits::fast_ord::FastOrd}};
