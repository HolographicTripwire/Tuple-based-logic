...
use crate::{
    propositions::{
        ...
        types::{
            ...
            unassigned::UnassignedProposition,
        },
    },
...
pub trait GetBinderForPropsSubsumedByUprop<SubsumerElemUprop: UnassignedProposition>:
    Binder
{
    ...
    fn get_subsumed_by<'prop, 'binder>(
        ...
        self.get_by_bounds(&Self::DefaultGetBoundsForPropsSubsumedByUprop::from(
            element,
        ))
    }
    fn get_subsumed_by_with_elem_to_map_constructor<'uprop,'binder,SubsumedMapProp,Assignment>(&'binder self, element: &'uprop SubsumerElemUprop)
    ...
    where
    SubsumedMapProp: Proposition,
    Assignment: PropositionalAssignment<SubsumerElemUprop,SubsumedMapProp>,
    Self::DefaultGetBoundsForPropsSubsumedByUprop<'uprop>: GetBoundsForConstructiblePropsSubsumedByUprop<'uprop,SubsumedMapProp,SubsumerElemUprop,Assignment,Self>
        {
        Self::DefaultGetBoundsForPropsSubsumedByUprop::from(element)
            .get_from_with_elem_to_map_constructors(self)
    }
}

pub trait InsertBinderForProp<'elem, ElemProp: 'elem + Proposition>:
