use crate::{
    propositions::types::assigned::{
        Proposition,
        collections::sets::{PropSet1O, PropSet2O},
    },
    utils::{
...
impl<P: Proposition + FastOrd> PropSet1O<P> for TinyImmutablePropSet1O<P> {
    ...
    where
        P: 'a,
    {
        TinyImmutableOrderedSet::iter(self)
    }
...
pub type TinyImmutablePropSet2O<P: Proposition + FastOrd> =
    TinyImmutableOrderedSet<TinyImmutablePropSet1O<P>>;
impl<P: Proposition + FastOrd> PropSet2O<P> for TinyImmutablePropSet2O<P> {
    type I = TinyImmutablePropSet1O<P>;
    fn iter<'a>(&'a self) -> impl Iterator<Item = &Self::I>
    where
        P: 'a,
    {
        TinyImmutableOrderedSet::iter(self)
