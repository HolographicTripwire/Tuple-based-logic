use crate::propositions::{
    ...
    types::{
        ...
        unassigned::{UnassignedProposition, UnassignedPropositionForProp},
    },
};
...
pub trait NormalisedUnassignedProposition: Sized + Into<Self::Inner> {
    ...
    fn apply_assignment<Prop: Proposition, Assignment: PropositionalAssignment<Self::Inner, Prop>>(
        &self,
        assignment: Assignment,
    ) -> Result<Prop, ()>
    where
        Self::Inner: UnassignedPropositionForProp<Prop>,
    {
        self.inner().assign(assignment)
    }
    fn construct_assignment<Prop: Proposition>(
        &self,
        assigned: Prop,
    ) -> Result<<Self::Inner as UnassignedPropositionForProp<Prop>>::DefaultAssignment, ()>
    where
        Self::Inner: UnassignedPropositionForProp<Prop>,
    {
