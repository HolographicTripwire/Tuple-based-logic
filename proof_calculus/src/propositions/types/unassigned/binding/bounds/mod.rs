...
use crate::{propositions::{assignments::{PartialPropositionalAssignment, PartialPropositionalAssignmentConstructor, PropositionalAssignment, PropositionalAssignmentConstructor}, types::{assigned::Proposition, unassigned::UnassignedProposition}}, utils::collections::binding::{binders::{Binder, InsertBinder}, bounds::{GetBounds, InsertBounds, UniqueGetBounds}}};
...
pub trait GetBoundsForConstructibleUpropsEquivalentToUprop<'elem,
...
>: GetBoundsForUpropsEquivalentToUprop<'elem,ElemUprop,B> {
    ...
    fn get_from_with_map_to_elem_constructors<'binder>(&self, binder: &'binder B) -> HashSet<(&'binder B::Value, Self::MapToElemConstructor)>;
}

pub trait GetBoundsForUpropsSubsumingProp<'elem, ElemProp: 'elem + Proposition, B: Binder>: GetBounds<B> + From<&'elem ElemProp> {}
pub trait GetBoundsForConstructibleUpropsSubsumingProp<'elem,
    MapUprop: UnassignedProposition,
...
pub trait GetBoundsForUpropsSubsumingUprop<'elem, ElemUprop: 'elem + UnassignedProposition, B: Binder>: GetBounds<B> + From<&'elem ElemUprop> {}
pub trait GetBoundsForConstructibleUpropsSubsumingByUprop<'elem,
    MapUprop: UnassignedProposition,
    ElemUprop:'elem + UnassignedProposition,
    B: Binder,
    MapToElemAssignment: PartialPropositionalAssignment<MapUprop,ElemUprop>
...
pub trait GetBoundsForConstructibleUpropsSubsumedByUprop<'elem,
    MapUprop: UnassignedProposition,
    ElemUprop:'elem + UnassignedProposition,
    B: Binder,
    ElemToMapAssignment: PartialPropositionalAssignment<ElemUprop,MapUprop>
