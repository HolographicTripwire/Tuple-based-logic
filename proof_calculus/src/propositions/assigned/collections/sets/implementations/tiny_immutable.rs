use crate::{propositions::assigned::{Proposition,collections::sets::{PropSet1O, PropSet2O}}, utils::{collections::sets::tiny_immutable_ordered_set::TinyImmutableOrderedSet, traits::fast_ord::FastOrd}};
