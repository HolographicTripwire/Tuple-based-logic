use crate::{structures::{inferences::located::InferenceAtPath, propositions::Proposition}, verification::validity::{ValidatableInferenceRule, stepper::ProofValidityStepResultWrapper, validate_located_inference}};
