use crate::{generation::expressions::{compound::UnassignedCompoundTblExpression, subexpressions::{ParentOfUnassignedSubexpressions, immediate::ParentOfImmediateUnassignedSubexpressions}, variable::TblExpressionVariable}, structures::expressions::{TblExpression, atomic::AtomicTblExpression, compound::{CompoundTblExpression, r#box::BoxCompoundTblExpression}, subexpressions::{TblSubexpressionInExpressionPath, immediate::ImmediateSubexpressionInExpressionPath}}};
...
mod from {
    ...
    use crate::{generation::expressions::{UnassignedTblExpression, compound::UnassignedCompoundTblExpression, variable::TblExpressionVariable}, structures::expressions::{TblExpression, atomic::AtomicTblExpression, compound::CompoundTblExpression}};
