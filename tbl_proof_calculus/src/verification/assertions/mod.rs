...
pub fn format_expression_subpath_error<C:CompoundTblExpression,Path>(err: ExpressionSubpathError<C,Path>) -> String {
...
pub fn expression_subexpression<'a,C:CompoundTblExpression,ParentPath,JoinedPath: From<(ParentPath,SubexpressionInExpressionPath)>>(expression: &'a TblExpressionAtPath<'a,C,ParentPath>, subpath: SubexpressionInExpressionPath) -> Result<TblExpressionAtPath<'a,C,JoinedPath>,ExpressionSubpathError<C,ParentPath>> {
...
pub fn expression_as_slice<'a,C:CompoundTblExpression,Path>(expression: &'a TblExpressionAtPath<'a,C,Path>) -> Result<Box<[TblExpressionAtPath<'a,C,Path>]>,ExpressionAtomicityCheckError<C,Path>> {
...
pub fn expression_into_slice<'a,C:CompoundTblExpression,Path>(expression: TblExpressionAtPath<'a,C,Path>) -> Result<Box<[TblExpressionAtPath<'a,C,Path>]>,ExpressionAtomicityCheckError<C,Path>> {
    if let TblExpression::Atomic(_) = expression.obj { return Err(ExpressionAtomicityCheckError {
        expected_atomicity: false,
        expression: expression.clone().into()
    }) };
...
pub fn expression_as_sized_slice<'a,const EXPECTED_SIZE: usize,C:CompoundTblExpression,Path>(expression: &'a TblExpressionAtPath<'a,C,Path>) -> Result<Box<[TblExpressionAtPath<'a,C,Path>; EXPECTED_SIZE]>,ExpressionLengthCheckError<C,Path>> {
...
pub fn expression_into_sized_slice<'a,const EXPECTED_SIZE: usize,C:CompoundTblExpression,Path>(expression: TblExpressionAtPath<'a,C,Path>) -> Result<Box<[TblExpressionAtPath<'a,C,Path>; EXPECTED_SIZE]>,ExpressionLengthCheckError<C,Path>> {
