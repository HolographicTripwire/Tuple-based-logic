...
use crate::expressions::{
    ...
    types::{
        assigned::{
            ...
            subexpressions::OwnedTblExpressionAtomInExpression,
        },
...
pub type TblReverseAssignmentAtomValueConflictErrorInExpression<'a, C: TblExpressionCompound> =
    ObjAtPath<'a, TblReverseAssignmentAtomValueError<C>, TblSubexpressionInExpressionPath>;
pub type OwnedTblReverseAssignmentAtomValueConflictErrorInExpression<C: TblExpressionCompound> =
    OwnedObjAtPath<TblReverseAssignmentAtomValueError<C>, TblSubexpressionInExpressionPath>;

pub struct TblReverseAssignmentCompoundLengthConflictError {
    pub unassigned_length: usize,
    pub assigned_length: usize,
}
pub type TblReverseAssignmentCompoundLengthConflictErrorInExpression<'a> = ObjAtPath<
    'a,
    TblReverseAssignmentCompoundLengthConflictError,
    TblSubexpressionInExpressionPath,
>;
pub type OwnedTblReverseAssignmentCompoundLengthConflictErrorInExpression = OwnedObjAtPath<
    TblReverseAssignmentCompoundLengthConflictError,
    TblSubexpressionInExpressionPath,
>;

pub struct TblReverseAssignmentVariableConflictError<C: TblExpressionCompound>(
    pub KeyConflictError<TblExpressionVariable, TblExpression<C>>,
);
...
impl<C: TblExpressionCompound> TblReverseAssignmentError<C> {
    pub fn atom_value_conflict(
        ...
        assigned_expression: TblExpression<C>,
        path: TblSubexpressionInExpressionPath,
    ) -> Self {
        Self::AtomValueInequal(OwnedObjAtPath {
            obj: TblReverseAssignmentAtomValueError {
                unassigned_atom,
                assigned_expression,
            },
            path,
    ...
    pub fn compound_length_conflict(
        ...
        Self::CompoundLengthConflict(OwnedObjAtPath {
            obj: TblReverseAssignmentCompoundLengthConflictError {
                unassigned_length,
                assigned_length,
            },
            path,
