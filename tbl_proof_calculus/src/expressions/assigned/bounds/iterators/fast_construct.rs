...
use proof_calculus::propositions::bounds::GetBoundsForPropIdenticalToProp;

use crate::expressions::assigned::{TblExpression, at_path_enum::TblSubexpressionInExpressionEnum, bounds::{TblExpressionBoundAtomExactValue, TblExpressionBoundCompoundExactLength, TblExpressionIdentityBound, iterators::ImportantPathsConstructor}, compound::CompoundTblExpression, subexpressions::{TblSubexpressionInExpression, TblSubexpressionInExpressionPath, immediate::LocatedParentOfImmediateSubexpressions}};
...
impl <'a, C: CompoundTblExpression> GetBoundsForPropIdenticalToProp<'a, TblExpression<C>,TblExpressionIdentityBound> for TblExpressionFastConstructIdentityBounds<'a,C> {
