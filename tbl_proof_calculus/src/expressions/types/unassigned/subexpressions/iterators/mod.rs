use crate::expressions::types::{assigned::atom::{TblExpressionAtom, TblExpressionAtomAtPath}, unassigned::{UnassignedTblExpression, UnassignedTblExpressionAtPath, compound::UnassignedTblExpressionCompound, variable::{TblExpressionVariable, TblExpressionVariableAtPath}}};

pub mod depth_first;

trait UnassignedTblExpressionIterator<'a,C: 'a + UnassignedTblExpressionCompound>: Sized + Iterator<Item = &'a UnassignedTblExpression<C>> {
...
impl <'a,C: 'a + UnassignedTblExpressionCompound,I: Iterator<Item = &'a UnassignedTblExpression<C>>> UnassignedTblExpressionIterator<'a,C> for I {}

trait UnassignedTblExpressionAtPathIterator<'a,C: 'a + UnassignedTblExpressionCompound,Path>: Sized + Iterator<Item = UnassignedTblExpressionAtPath<'a,C,Path>> {
    fn filter_atoms(self) -> impl Iterator<Item = TblExpressionAtomAtPath<'a,Path>> { self.filter_map(|expr| match expr.obj {
        UnassignedTblExpression::Atom(atom) => Some(TblExpressionAtomAtPath { obj: atom, path: expr.path }),
        UnassignedTblExpression::Variable(_) => None,
        UnassignedTblExpression::Compound(_) => None,
    })}
...
impl <'a,C: 'a + UnassignedTblExpressionCompound,Path,I: Iterator<Item = UnassignedTblExpressionAtPath<'a,C,Path>>> UnassignedTblExpressionAtPathIterator<'a,C,Path> for I {}
