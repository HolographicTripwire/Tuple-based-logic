...
use crate::expressions::{
    ...
    types::{
        ...
        unassigned::binding::bounds::UnassignedTblExpressionBoundVariableExactValue,
    },
};
...
impl UnassignedTblExpressionInsertionBound {
    fn path(
        ...
        match self {
            ...
            UnassignedTblExpressionInsertionBound::ValueDuplicated(duplication_bound) => {
                (duplication_bound.path1(), Some(duplication_bound.path2()))
            }
        }
    }
}
impl GetBound for UnassignedTblExpressionInsertionBound {
...
impl From<UnassignedTblExpressionBoundVariableExactValue>
    for UnassignedTblExpressionInsertionBound
{
