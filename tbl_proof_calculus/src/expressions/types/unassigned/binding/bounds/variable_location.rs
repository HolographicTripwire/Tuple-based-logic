...
impl GetBound for UnassignedTblExpressionBoundVariableExistsAtLocation {
    type ExtraReturnData = TblExpressionVariable;
}

pub type UnassignedTblPropositionBoundVariableExistsAtLocation =
