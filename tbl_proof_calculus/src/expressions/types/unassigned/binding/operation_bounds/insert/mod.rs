...
use crate::expressions::types::{assigned::binding::bounds::{TblExpressionBoundAtomExactValue, TblExpressionBoundCompoundExactLength, TblExpressionBoundValueDuplicated}, unassigned::{UnassignedTblExpression, at_path_enum::UnassignedTblExpressionAtPathEnum, binding::bounds::{UnassignedTblExpressionBoundVariableExactValue, UnassignedTblExpressionInsertionBound}, compound::UnassignedTblExpressionCompound, subexpressions::iterators::{depth_first::counterclockwise::CounterclockwiseDepthFirstLocatedUnassignedTblSubexpressionIterator}}};
...
impl <'prop,C: 'prop + UnassignedTblExpressionCompound,B:InsertBinder<Self>> InsertBoundsForUprop<'prop,UnassignedTblExpression<C>,B> for TblFastConstructInsertionBoundsForUprop {}

impl <'a, C: UnassignedTblExpressionCompound> From<&'a UnassignedTblExpression<C>> for TblFastConstructInsertionBoundsForUexpr {
