use proof_calculus::{
    propositions::types::unassigned::binding::bounds::InsertBoundsForUprop,
...
use crate::expressions::types::{
    ...
    unassigned::{
        ...
        binding::bounds::{
            UnassignedTblExpressionBoundVariableExactValue, UnassignedTblExpressionInsertionBound,
        },
...
impl<'prop, C: 'prop + UnassignedTblExpressionCompound, B: InsertBinder<Self>>
    InsertBoundsForUprop<'prop, UnassignedTblExpression<C>, B>
    for TblFastConstructInsertionBoundsForUprop
{
}

impl<'a, C: UnassignedTblExpressionCompound> From<&'a UnassignedTblExpression<C>>
    for TblFastConstructInsertionBoundsForUexpr
{
...
impl TblFastConstructInsertionBoundsForUexpr {
    pub fn bounds(&self) -> &Box<[UnassignedTblExpressionInsertionBound]> {
        &self.0
    }
}
