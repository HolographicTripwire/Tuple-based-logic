    ...
    expressions::types::{
        ...
        unassigned::{
            ...
            binding::bounds::{
                ...
                UnassignedTblExpressionIdentityBound,
            },
...
pub struct TblFastConstructGetBoundsForUexprIdenticalToUexpr(
    Box<[UnassignedTblExpressionIdentityBound]>,
);
pub type TblFastConstructGetBoundsForUpropIdenticalToUprop =
    TblFastConstructGetBoundsForUexprIdenticalToUexpr;

impl<B: GetBinder<UnassignedTblExpressionIdentityBound>> GetBounds<B>
    for TblFastConstructGetBoundsForUexprIdenticalToUexpr
{
    fn get_from<'binder>(&self, binder: &'binder B) -> HashSet<&'binder <B as Binder>::Value> {
        binder.get_intersection(self.0.iter())
    }
}
impl<B: GetBinder<UnassignedTblExpressionIdentityBound>> UniqueGetBounds<B>
    for TblFastConstructGetBoundsForUexprIdenticalToUexpr
{
}
impl<
    ...
    B: GetBinder<UnassignedTblExpressionIdentityBound>,
> GetBoundsForUpropIdenticalToUprop<'prop, UnassignedTblProposition<C>, B>
    for TblFastConstructGetBoundsForUexprIdenticalToUexpr
{
}
impl<'a, C: UnassignedTblExpressionCompound> From<&'a UnassignedTblExpression<C>>
    for TblFastConstructGetBoundsForUpropIdenticalToUprop
{
        ...
        let bounds = CounterclockwiseDepthFirstLocatedUnassignedTblSubexpressionIterator::new(expr)
            .map(|v| match v.into() {
                ...
                UnassignedTblExpressionAtPathEnum::Variable(variable) => {
                    UnassignedTblExpressionBoundVariableExactValue::new(
                        variable.path,
                        *variable.obj,
                    )
                    .into()
...
impl TblFastConstructGetBoundsForUexprIdenticalToUexpr {
    pub fn bounds(&self) -> &Box<[UnassignedTblExpressionIdentityBound]> {
        &self.0
    }
}
