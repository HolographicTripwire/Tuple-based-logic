...
use proof_calculus::{
    propositions::types::unassigned::binding::bounds::GetBoundsForUpropsEquivalentToUprop,
        ...
        types::{
            ...
            unassigned::{
                ...
                binding::bounds::{
                    ...
                    UnassignedTblExpressionEquivalenceBound,
                },
...
pub struct TblFastConstructGetBoundsForUexprsEquivalentToUexpr(
    Box<[UnassignedTblExpressionEquivalenceBound]>,
);
    ...
    for TblFastConstructGetBoundsForUpropsEquivalentToUprop
{
    fn from(expr: &'a UnassignedTblExpression<C>) -> Self {
        ...
        for expr in CounterclockwiseDepthFirstLocatedUnassignedTblSubexpressionIterator::new(expr) {
            match expr.into() {
                ...
                UnassignedTblExpressionAtPathEnum::Variable(variable) => {
                    ...
                    bounds.push(
                        UnassignedTblExpressionBoundVariableExistsAtLocation::new(variable.path)
                            .into(),
                    );
                }
