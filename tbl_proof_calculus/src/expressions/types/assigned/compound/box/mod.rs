...
impl ParentOfImmediateSubexpressions<BoxTblExpressionCompound> for BoxTblExpressionCompound {
    ...
    fn get_immediate_subexpression(&self,path: &ImmediateTblSubexpressionInExpressionPath) -> Result<&TblExpression<BoxTblExpressionCompound>,()>
...
impl ParentOfSubexpressions<BoxTblExpressionCompound> for BoxTblExpressionCompound {
    ...
    fn get_subexpression(&self,path: &TblSubexpressionInExpressionPath) -> Result<&TblExpression<BoxTblExpressionCompound>,()> { 
