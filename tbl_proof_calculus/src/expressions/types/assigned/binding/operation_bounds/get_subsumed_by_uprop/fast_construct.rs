...
impl <'prop,C: 'prop + UnassignedTblExpressionCompound, B: GetBinder<TblExpressionInsertionBound>> GetBoundsForPropsSubsumedByUprop<'prop,UnassignedTblProposition<C>,B> for TblFastConstructGetBoundsForExprsSubsumedByUexpr {}
impl <'a, C: UnassignedTblExpressionCompound> From<&'a UnassignedTblExpression<C>> for TblFastConstructGetBoundsForPropsSubsumedByUprop {
