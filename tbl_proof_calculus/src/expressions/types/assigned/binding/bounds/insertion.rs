...
use crate::expressions::{
    ...
    types::assigned::binding::bounds::{
        atom_value::TblExpressionBoundAtomExactValue,
        compound_length::TblExpressionBoundCompoundExactLength,
        value_duplication::TblExpressionBoundValueDuplicated,
    },
};
...
impl TblExpressionInsertionBound {
    fn path(
        ...
        match self {
            ...
            TblExpressionInsertionBound::ValueDuplicated(duplication_bound) => {
                (duplication_bound.path1(), Some(duplication_bound.path2()))
            }
        }
    }
}
impl GetBound for TblExpressionInsertionBound {
