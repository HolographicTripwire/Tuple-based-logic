...
use crate::expressions::{
    paths::TblSubexpressionInExpressionPath, types::assigned::atom::TblExpressionAtom,
};
...
impl GetBound for TblExpressionBoundAtomExistsAtLocation {
    type ExtraReturnData = TblExpressionAtom;
}
