...
impl <C1:TblExpressionCompound,Path,C2:TblExpressionCompound> ExpressionValueCheckError<C1,Path,C2> {
...
pub fn assert_expression_value<'a,C1:TblExpressionCompound + PartialEq<C2>,Path: Clone,C2:TblExpressionCompound + PartialEq<C1>>(expr: &TblExpressionAtPath<'a,C1,Path>, expected_value: &TblExpression<C2>) -> Result<(), ExpressionValueCheckError<C1,Path,C2>> {
