...
pub struct ExpressionValueInequalityError<C: TblExpressionCompound, Path> {
...
pub fn assert_expression_value_inequality<'a,C: TblExpressionCompound,Path:Clone>(exprs: &[&'a TblExpressionAtPath<'a,C,Path>]) -> Result<(), ExpressionValueInequalityError<C,Path>> {
...
pub struct FixedLengthExpressionValueInequalityError<const N: usize,C: TblExpressionCompound,Path> {
...
pub fn assert_fixed_length_expression_value_inequality<'a,const N: usize,C:TblExpressionCompound,Path:Clone>(exprs: &[&'a TblExpressionAtPath<'a,C,Path>; N]) -> Result<(), FixedLengthExpressionValueInequalityError<N,C,Path>> {
