...
pub fn expression_parser<'a>(style: &'a ExpressionStyle<'a>) -> Parser<'a,char,Expression> {
    raw_expression_parser(style.raw_expr_style())
        .or(processed_expression_parser(style))
}

fn processed_expression_parser<'a>(style: &'a ExpressionStyle<'a>) -> Parser<'a,char,Expression> {
